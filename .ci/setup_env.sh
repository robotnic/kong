...
# Download
#---------
OPENSSL_DOWNLOAD=$DOWNLOAD_CACHE/$TRAVIS_BRANCH/openssl-$OPENSSL
OPENRESTY_DOWNLOAD=$DOWNLOAD_CACHE/$TRAVIS_BRANCH/openresty-$OPENRESTY
OPENRESTY_PATCHES_DOWNLOAD=$DOWNLOAD_CACHE/$TRAVIS_BRANCH/openresty-patches-master
LUAROCKS_DOWNLOAD=$DOWNLOAD_CACHE/$TRAVIS_BRANCH/luarocks-$LUAROCKS
CPAN_DOWNLOAD=$DOWNLOAD_CACHE/$TRAVIS_BRANCH/cpanm
...
if [ ! "$(ls -A $OPENSSL_DOWNLOAD)" ]; then
  pushd $DOWNLOAD_CACHE/$TRAVIS_BRANCH
...
# Install
#--------
OPENSSL_INSTALL=$INSTALL_CACHE/$TRAVIS_BRANCH/openssl-$OPENSSL
OPENRESTY_INSTALL=$INSTALL_CACHE/$TRAVIS_BRANCH/openresty-$OPENRESTY
LUAROCKS_INSTALL=$INSTALL_CACHE/$TRAVIS_BRANCH/luarocks-$LUAROCKS
